...
export const Drop_ko = () => (
  <div class="prose prose-lg dark:prose-invert max-w-none">
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      ...
      <br />
      <br />
      이 함수는 커링되어 있어, 제거할 요소의 개수를 미리 설정하고 재사용할 수 있습니다.
    </p>
...
// 제거할 요소의 개수를 받음
// 배열을 받아 앞의 n개 요소를 제거한 배열을 반환하는 함수를 반환`}
    />
...
// []`}
    ...
    <div class="space-y-6">
      ...
      <div>
        ...
        <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed">
          <code class="px-2 py-1 bg-gray-200 dark:bg-gray-700 rounded">dropHeader = drop(1)</code>처럼
          재사용 가능한 함수를 만들어 코드베이스 전체에서 사용할 수 있습니다.
        </p>
      </div>
