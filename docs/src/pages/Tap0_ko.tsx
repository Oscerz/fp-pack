...
export const Tap0_ko = () => (
  <div class="prose prose-lg dark:prose-invert max-w-none">
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      ...
      는 <code class="text-sm">tap</code>의 0-인자 버전입니다. 입력 없이 부수 효과를 실행하고
      아무 값도 반환하지 않습니다.
      <br />
      <br />
      값이 흐르지 않는 시작 지점(초기화, 로깅, 타이머 등)에 사용하세요. 파이프라인에서
      값이 유지되어야 한다면 <code class="text-sm">tap</code>을 사용하세요.
    </p>
...
// Logs: "booting..."`}
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      반환된 함수를 호출하면 부수 효과가 실행됩니다. 입력은 필요하지 않습니다.
    </p>
...
// Returns: 2`}
    ...
    <p class="text-sm md:text-base text-gray-700 dark:text-gray-300 leading-relaxed mb-6">
      <code class="text-sm">tap0</code>의 구현을 GitHub에서 확인하세요.
    </p>
